'use strict';
var precacheConfig = [
    ['/index.html', 'fa6b300d1a461eaf53cacf744a72cee9'],
    ['/static/css/main.7cd1dad1.css', '11d7c5e0222bc894b0c30039b31e6abc'],
    ['/static/js/main.c603d8f1.js', 'bd83befc87fc57b6aeb4c20d7eec764e']
  ],
  cacheName =
    'sw-precache-v3-sw-precache-webpack-plugin-' + (self.registration ? self.registration.scope : ''),
        ...
        e &&
          t.respondWith(
            caches
              ...
              .catch(function(e) {
                return (
                  console.warn('Couldn\'t serve response for "%s" from cache: %O', t.request.url, e),
                  fetch(t.request)
                );
              })
          );
